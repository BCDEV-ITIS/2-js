...
5. Créez une nouvelle page détaillée d'un utilisateur `/users/i{id}` cf. illustration ci-dessous.

---

## Bonus

1. Gérez les cas d'erreur en affichant du contenu par défaut en cas d'erreur lors de la récupération des informations depuis les ressources externes

---


### Exemples non contractuels des pages

![all](./img/mockup-ex5.png)
